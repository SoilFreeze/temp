...
def get_universal_portal_data(project_id):
    ...
    # LAYER 1: DATABASE LEVEL ANOMALY CLEANING
    # Hard-filters extreme sensor artifacts (< -30°F or > 120°F) right at ingestion
    query = f"""
...
def render_summary_tab(full_p_df, unit_label, local_tz):
    ...
    # LAYER 2: PRIORITY ROUTING
    # Catches Ambient identifiers FIRST to insulate looping calculations from hot air profiles
    ...
    # Capture rolling historic frame for range tracking
    ...
    # LAYER 3: MATH SNAPSHOT ALIGNMENT
    # Groups by unique sensor nodes and pulls the last packet to derive true current means
    ...
    for i, p_type in enumerate(categories):
        with cols[i]:
            ...
            # Averages calculated strictly out of the latest packet arrays
            ...
            # Embed Dashboard Percent Target Badges
...
def render_client_portal():
    ...
    # LAYER 4: FAILSAFE APPLICATION DATA CLAMP
